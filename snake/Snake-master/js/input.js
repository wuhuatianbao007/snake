...
host.addEventListener('keyup',function(e) {
	// input.states[e.keyCode] = false;
	input.states[e.keyCode] = { pressed : false };
	/*var state = states[e.keyCode];
	if(!state){
		state = states[e.keyCode] = {};
	}
	state.locked = state.pressed = false;*/
},false);

host.addEventListener('keydown',function(e) {
	// input.states[e.keyCode] = true;
	var state = states[e.keyCode];
